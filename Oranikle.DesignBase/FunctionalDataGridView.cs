...
{
    public class FunctionalDataGridView : StyledDataGridView, ISupportInitialize
    {
        ...
        {
            if (this.summaryControl != null)
                this.summaryControl.SetValue(column, value);
        }
         ...
         public void SetValue(DataGridViewColumn column, object value, string format)
         {
             ...
             {
                 if (this.summaryControl != null)
                     this.summaryControl.SetValue(column, value, format);
             }
             catch (Exception ex)
             { }
         }
        ...
        private void resizeHScrollBar()
        {
            ...
            if (columnsWidth > 0)
            {
                ...
                //this.hScrollBar.Maximum = columnsWidth - (ClientSize.Width - RowHeadersWidth - vscrollbarWidth);  //step 1 
